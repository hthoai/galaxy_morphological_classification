...
"""
Ensemble model 2 with the following mods: 
1. Dropout rate 0.5 -> 0.8
"""

class EnsemModel2(Module):
    def __init__(self):
        super(EnsemModel2,self).__init__()
        ...
        self.dropout = Dropout(p=0.8, inplace=True)
